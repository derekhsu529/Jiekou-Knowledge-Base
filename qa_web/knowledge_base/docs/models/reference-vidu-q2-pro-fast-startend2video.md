---
title: "VIDU Q2 Pro Fast 首尾帧"
url: "https://docs.jiekou.ai/docs/models/reference-vidu-q2-pro-fast-startend2video.md"
crawled_at: "2026-02-26T23:35:59.505585"
---

Published Time: Thu, 26 Feb 2026 15:35:59 GMT
...
根据首尾两帧图像生成连贯的视频（快速模式）。支持 720p、1080p 两种分辨率。快速模式可显著缩短生成时间，适合对速度要求较高的场景。
...
## 请求体
 ...
 输出视频的分辨率。支持 720p 和 1080p。默认值为 720p。 可选值：`720p`, `1080p` 
