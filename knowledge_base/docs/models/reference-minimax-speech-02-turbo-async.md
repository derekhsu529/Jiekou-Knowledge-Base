---
title: "MiniMax Speech-02-turbo 异步语音合成"
url: "https://docs.jiekou.ai/docs/models/reference-minimax-speech-02-turbo-async.md"
crawled_at: "2026-02-26T23:38:11.976210"
---

Published Time: Thu, 26 Feb 2026 15:38:11 GMT
...
适用于整本书籍等长文本的语音生成，任务排队耗时可能会较长。短句生成、语音聊天、在线社交等场景，建议使用 [同步调用语音合成](/docs/models/reference-minimax-speech-02-turbo)。
